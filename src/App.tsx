...
const contextMap: Record<number, Record<number, string | undefined>> = {
  ...
  2: {
    ...
    7: '「TORIA」は創立10周年を迎え、これまでのコレクションや広告表現を整理し直した。“流行よりも長く愛される日常服”という原点に立ち返り、ブランドの軸を再確認。長く支持されるブランドを目指す姿勢を明確にするリブランディングを実施した。なおこの設問では、確認のため必ず前後どちらのゴロも「5」を選んでください。',
  },
  3: {
